 ...
 * @author dzenm
 */
public class NaughtyDelegate {

    private static final String TAG = NaughtyDelegate.class.getSimpleName();
    ...
    private static volatile NaughtyDelegate sInstance;
    ...
    public static NaughtyDelegate getInstance() {
        if (sInstance == null) {
            synchronized (NaughtyDelegate.class) {
                if (sInstance == null) {
                    sInstance = new NaughtyDelegate();
                }
            }
        }
        return sInstance;
